...
(function( global, factory ) {
    ...
    if ( typeof module === "object" && typeof module.exports === "object" ) {
        ...
        // e.g. var Nuclear = require("ywnuclear")(window);
        // e.g. var Nuclear = require("ywnuclear")(jsdom.jsdom().defaultView);
...
App.componentRes['component/yw_Console/index.html'] =
...
\
<div class="at-entry" nc-id="atEntry" onclick="toggleEntry()"  ontouchstart="touchStart(event)" style="transform: translate3d({{tx}}px,{{ty}}px,0px);-webkit-transform: translate3d({{tx}}px,{{ty}}px,0px);">cxjConsole</div>\
<div class="at-ctn {{#hide}}at-hide{{/hide}}">\
    ...
    <div class="at-toolbar">\
        <a href="javascript:;" onclick="clearLogs()" class="at-tool at-clear">Clear</a><a href="https://github.com/ywTeam/Nuclear" class="at-tool at-tool-right">Powered By Nuclear</a>\
    </div>\
</div>';

;(function () {
    var tpl = App.loadFile("component/yw_Console/index.html");

    var cxjConsole = Nuclear.create({
        install: function () {
            this.initConsole();
            this.initError();
            this.initXHR();
        ...
        initXHR:function(){
            (function(open){
                window.XMLHttpRequest.prototype.open=function(){
                    this.cxjConsoleMethod=arguments[0];
                    this.cxjConsoleUrl=arguments[1];
                    ...
                    if ((xhr.status >= 200 && xhr.status < 300) || xhr.status == 304) {
                        try {
                            self.option.xhrs.realPush({
                                method: xhr.cxjConsoleMethod,
                                rqsUrl: xhr.cxjConsoleUrl,
    ...
    window.cxjConsole= cxjConsole;
})();
})();
(function(){
    try {
        var al=new cxjConsole({
            hide: true,
            reportTo: 'xxx',
            height: '55%',
            index: 1,
